...
class anon_csat_NTF_yes_new(unittest.TestCase):
    ...
    def test_anon_csat_ntf_yes_new(self):
        sel = self.selenium
        ...
        # for KB articles under "New to Firefox" section.
        poll_option = 1
        while poll_option < 6:
            ...
            self.failIf(sel.is_visible("polls_optionId"),
