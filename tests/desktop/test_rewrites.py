...
class TestRedirects:
    ...
    def _check_redirect(self, testsetup, start_url, user_agent=_user_agent_firefox, locale='en-US'):
        if 'support.mozilla.org' not in testsetup.base_url:
            pytest.skip("Skipped per dev instructions on continuous deployment.  To be run only on Prod")
    ...
    @pytest.mark.parametrize(('input', 'expected'), [
        ('/1/firefox/4.0/WINNT/en-US/firefox-help/', '/en-US/products/firefox?as=u&utm_source=inproduct'),
        ('/1/firefox/4.0/WINNT/en-US/firefox-f1/', '/en-US/products/firefox?as=u&utm_source=inproduct'),
        ('/1/firefox/4.0/WINNT/en-US/firefox-osxkey/', '/en-US/products/firefox?as=u&utm_source=inproduct'),
        ('/1/firefox/4.0/Darwin/en-US/firefox-help/', '/en-US/products/firefox?as=u&utm_source=inproduct'),
        ('/1/firefox/4.0/Darwin/en-US/firefox-f1/', '/en-US/products/firefox?as=u&utm_source=inproduct'),
        ('/1/firefox/4.0/Darwin/en-US/firefox-osxkey/', '/en-US/products/firefox?as=u&utm_source=inproduct'),
        ('/1/firefox/4.0/Linux/en-US/firefox-help/', '/en-US/products/firefox?as=u&utm_source=inproduct'),
        ('/1/firefox/4.0/Linux/en-US/firefox-f1/', '/en-US/products/firefox?as=u&utm_source=inproduct'),
        ('/1/firefox/4.0/Linux/en-US/firefox-osxkey/', '/en-US/products/firefox?as=u&utm_source=inproduct'),
    ])
